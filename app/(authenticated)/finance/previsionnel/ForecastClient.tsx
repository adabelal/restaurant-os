        ...
        <div className="flex flex-col items-center justify-center gap-3">
            <div className="relative w-36 h-36">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-4xl font-black text-foreground" style={{ color }}>{score}</span>
...
function CustomTooltip({ active, payload, label }: any) {
    ...
    return (
        <div className="bg-card border border-border p-4 rounded-2xl shadow-2xl min-w-[180px]">
    ...
    return (
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Health Score */}
                <Card className=" shadow-2xl bg-card rounded-3xl overflow-hidden border border-border shadow-sm lg:row-span-1">
                ...
                <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <Card className=" shadow-xl bg-card rounded-3xl overflow-hidden border border-border shadow-sm">
                        <CardContent className="p-6 flex flex-col gap-4 h-full justify-between">
                            <div>
                                ...
                                <p className="text-4xl font-black text-foreground mt-2">{monthProgressPct}<span className="text-xl text-muted-foreground">%</span></p>
                                <p className="text-xs font-bold text-muted-foreground mt-1">Jour {currentDayOfMonth} sur {totalDaysInMonth}</p>
                            </div>
                            <div>
                                <div className="h-3 w-full bg-muted-foreground/20 rounded-full overflow-hidden">
                                    <div
                                ...
                                <div className="flex justify-between mt-2 text-[9px] font-black text-muted-foreground opacity-70 uppercase">
                                    <span>1er</span>
                    ...
                    {/* Treasury Alert */}
                    <Card className={` shadow-xl rounded-3xl overflow-hidden ring-1 ${daysUntilZero !== null && daysUntilZero < 60 ? 'bg-gradient-to-br from-rose-950/60 to-[#0a0f1e] ring-rose-500/20' : 'bg-card ring-white/5'}`}>
                        <CardContent className="p-6 flex flex-col gap-4 h-full justify-between">
                            <div>
                                <div className="flex items-center gap-2 mb-1">
                                ...
                                {daysUntilZero !== null ? (
                                    <>
                                        <p className="text-4xl font-black text-foreground mt-2">
                                            {daysUntilZero} <span className="text-xl text-muted-foreground">jours</span>
                                        </p>
                                        <p className="text-xs font-bold text-muted-foreground mt-1">Avant tréso à zéro au rythme actuel</p>
                                    </>
                                ) : (
                                    <>
                                        <p className="text-2xl font-black text-emerald-400 mt-2">Flux Positif</p>
                                        <p className="text-xs font-bold text-muted-foreground mt-1">Votre cash flow mensuel est excédentaire</p>
                                    </>
                                )}
                            </div>
                            <div className="p-3 border-border rounded-xl flex justify-between items-center">
                                <span className="text-[9px] font-black text-muted-foreground uppercase">Flux Journalier Moyen</span>
                    ...
                    <Card className=" shadow-xl bg-card rounded-3xl overflow-hidden border border-border shadow-sm sm:col-span-2">
                        <CardContent className="p-6">
                            <div className="grid grid-cols-2 gap-6">
                                <div>
                                    <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em]">Solde Bancaire Actuel</p>
                                    <p className="text-3xl font-black text-foreground mt-2">{fmt(currentBalance)}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.3em]">Projection Fin de Mois</p>
                                ...
                                <div className="col-span-2">
                                    <div className="flex justify-between text-[9px] font-black uppercase text-muted-foreground opacity-70 mb-1.5">
            ...
            <div>
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h2 className="text-2xl font-black text-foreground tracking-tight">Moteur de Scénarios</h2>
                        <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest mt-1">Simulez les impacts sur votre rentabilité</p>
                    </div>
                    <div className="flex items-center gap-2 bg-muted p-1.5 rounded-2xl border border-border shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    {[
                        ...
                        return (
                            <Card key={i} className=" shadow-xl bg-card rounded-3xl overflow-hidden border border-border shadow-sm relative group overflow-hidden">
                                ...
                                <CardContent className="p-6 relative">
                                    ...
                                    <p className="text-3xl font-black text-foreground mb-3">{fmt(kpi.value)}</p>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[9px] font-bold text-muted-foreground opacity-70">vs base</span>
                                    </div>
                                </CardContent>
                            </Card>
                        )
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <Card className="lg:col-span-3  shadow-xl bg-card rounded-3xl overflow-hidden border border-border shadow-sm">
                    <CardHeader className="px-6 pt-6 pb-4">
                        ...
                        <CardDescription className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">CA vs Charges vs Résultat Net</CardDescription>
                    </CardHeader>
                ...
                {/* Waterfall Chart (2/5) */}
                <Card className="lg:col-span-2  shadow-xl bg-card rounded-3xl overflow-hidden border border-border shadow-sm">
                    <CardHeader className="px-6 pt-6 pb-4">
                        <CardTitle className="text-base font-black text-foreground flex items-center gap-2">
                            <Activity className="h-4 w-4 text-amber-400" /> Cascade de Résultat
                        </CardTitle>
                        <CardDescription className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Du CA au résultat net mensuel</CardDescription>
                    </CardHeader>
                    <CardContent className="px-2 pb-6">
                        <div className="h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                    ...
                                    <Tooltip content={({ active, payload }: any) => {
                                        ...
                                        return (
                                            <div className="bg-card border border-border p-4 rounded-2xl shadow-2xl">
                                                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-2">{d.name}</p>
            ...
            ═══════════════════════════════════════════════════════════ */}
            <div>
                <h2 className="text-2xl font-black text-foreground tracking-tight mb-1">Bilans Comptables</h2>
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-6">Exercices certifiés — données expert comptable</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {officialBaselines.map((b, idx) => {
                        ...
                        return (
                            <Card key={idx} className=" shadow-xl bg-card rounded-3xl overflow-hidden border border-border shadow-sm group hover:ring-indigo-500/30 transition-all duration-300">
                                <CardHeader className="px-6 py-5 border-b border-border flex flex-row items-center gap-4 space-y-0">
                                    <div className="h-12 w-12 bg-indigo-600 rounded-2xl flex items-center justify-center font-black text-foreground text-sm shadow-[0_0_20px_#6366f140] group-hover:scale-105 transition-transform">{b.year}</div>
                                    <div>
                                        <CardTitle className="text-base font-black text-foreground">Exercice {b.year}</CardTitle>
                                        <CardDescription className="text-[10px] font-black tracking-widest uppercase text-muted-foreground">{b.months} mois • BIC</CardDescription>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-6">
                                    <div className="grid grid-cols-2 gap-3">
                                        {[
                                            { label: "Chiffre d'Affaires", value: fmt(b.ca), sub: `${fmt(monthlyCA)} / mois`, color: 'text-foreground' },
                                            ...
                                            <div key={item.label} className="p-3 bg-muted/60 rounded-2xl border border-border">
                                                ...
                                                <p className="text-[9px] font-bold text-muted-foreground opacity-70 mt-0.5">{item.sub}</p>
                                            </div>
                                        ))}
                                    </div>
                                </CardContent>
            ...
            <Card className=" shadow-xl bg-card rounded-3xl overflow-hidden border border-border shadow-sm">
                <CardHeader className="px-8 py-6 border-b border-border">
                    <CardTitle className="text-xl font-black text-foreground">Détail par Catégorie</CardTitle>
                    <CardDescription className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Analyse granulaire • Moyenne {historicalMonths.join(', ')}</CardDescription>
                </CardHeader>
                <CardContent className="p-0">
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-border bg-muted/50">
                                    <th className="px-8 py-4 text-[9px] font-black text-muted-foreground uppercase tracking-widest w-10"></th>
                                    <th className="px-4 py-4 text-[9px] font-black text-muted-foreground uppercase tracking-widest">Catégorie</th>
                                    <th className="px-4 py-4 text-[9px] font-black text-muted-foreground uppercase tracking-widest text-right">Moy. Hist.</th>
                                    <th className="px-4 py-4 text-[9px] font-black text-muted-foreground uppercase tracking-widest text-right">% du CA</th>
                                    <th className="px-4 py-4 text-[9px] font-black text-muted-foreground uppercase tracking-widest text-right">Ce mois</th>
                                    <th className="px-4 py-4 text-[9px] font-black text-muted-foreground uppercase tracking-widest text-right">Reste prévu</th>
                                </tr>
                            </thead>
                    ...
                    <div className="px-8 py-4 border-t border-border flex items-center justify-between">
                        <p className="text-[9px] font-bold text-muted-foreground opacity-70 uppercase italic">* Reste prévu = Moyenne historique − Réalisé ce mois</p>
                        <div className="flex items-center gap-6">
                            <div className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-emerald-500" /><span className="text-[9px] font-black text-muted-foreground uppercase">Sous objectif</span></div>
                            <div className="flex items-center gap-2"><div className="h-1.5 w-1.5 rounded-full bg-rose-500" /><span className="text-[9px] font-black text-muted-foreground uppercase">Dépassement</span></div>
                        </div>
                    </div>
                </CardContent>
            </Card>
