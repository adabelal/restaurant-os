                ...
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <form action={async () => {
                            ...
                            <Button variant={employee.isActive ? "ghost" : "outline"} size="sm" className={employee.isActive ? "text-muted-foreground hover:text-red-500" : "text-emerald-500"}>
                                            ...
                                            employee.documents.filter((d: any) => d.type === "PAYSLIP").map((doc: any) => (
                                                <div key={doc.id} className="relative group">
                                                    ...
                                                    <form action={async () => {
                                                        ...
                                                        <Button size="icon" variant="ghost" className="h-6 w-6 text-red-400 hover:text-red-500 bg-background shadow-sm border border-border"><Trash2 className="h-3 w-3" /></Button>
                                                    </form>
                                                </div>
                                            ))
                                        )}
                                        ...
                                        <div key={doc.id} className="flex items-center justify-between p-3 border-b border-border last:border-0 group">
                                            ...
                                            <div className="flex items-center gap-1">
                                                ...
                                                <form action={async () => {
                                                    ...
                                                    <Button size="icon" variant="ghost" className="h-8 w-8 text-muted-foreground hover:text-red-500"><Trash2 className="h-4 w-4" /></Button>
                                                </form>
                                            </div>
                                        </div>
                                    ))}
